...
class SshKeyTest < ActiveSupport::TestCase
  ...
  context '#to_export' do
    ...
    test 'should clean up ssh key' do
      assert_equal 'ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBIhRoL6PfBRs9YwW3r2/pYeLrxRzEZSUO3Go8JivxMsguEKjJ3byHDPvPpMHhKKSZD/HJY/A+2Ndqp0ElB+t2qs= sshkeytestuser', ssh_key.to_export
    end
  end

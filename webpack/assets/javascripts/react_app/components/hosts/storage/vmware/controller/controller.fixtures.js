export const props = {
  ...
  config: {
    ...
    datastores: {
      ...
      'cfme-iso-glob-na01a-s':
				'cfme-iso-glob-na01a-s (free: 341 GB, prov: 134 GB, total: 475 GB)',
      'do-not-use-datastore':
				'do-not-use-datastore (free: 462 GB, prov: 12.6 GB, total: 475 GB)',
      'do-not-use-host-prov':
				'do-not-use-host-prov (free: 0 Bytes, prov: 973 MB, total: 973 MB)',
      'master_iso_rdu':
				'master_iso_rdu (free: 689 GB, prov: 289 GB, total: 973 GB)',
      'temp_store':
				'temp_store (free: 475 GB, prov: 19.5 MB, total: 475 GB)',
      vsanDatastore:
				'vsanDatastore (free: 207 GB, prov: 26.1 GB, total: 233 GB)'
    }
  },
  addDisk: () => {},
  removeDisk: () => {},
